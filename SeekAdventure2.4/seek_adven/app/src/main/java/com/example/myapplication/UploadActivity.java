...
public class UploadActivity extends AppCompatActivity {
    ...
    Button saveButton;
    EditText uploadTitle, uploadFacts, uploadMoments, uploadActivities;
    String imageURL;
    Uri uri;
    ...
    public void uploadData(){
        ...
        String date = uploadFacts.getText().toString();
        String location = uploadActivities.getText().toString();
